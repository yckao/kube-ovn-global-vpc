...
EXACT_INPUTS = (
    ...
    "config/examples/helm/authority.yaml", "config/examples/helm/authority-dc-a.yaml",
    "config/examples/helm/native.yaml",
    ...
    "integration/kube-ovn/compat-v1.16.3/native.patch",
    "integration/kube-ovn/compat-v1.16.3/README.md",
    "integration/kube-ovn/compat-v1.16.3/scripts/apply.py",
    "integration/kube-ovn/compat-v1.16.3/scripts/build.py",
